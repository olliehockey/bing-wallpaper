...
The default interval is 600 seconds. The minimum supported interval is 60 seconds. A shorter interval can help if Windows occasionally restores an old wallpaper after display or monitor changes.
